  ...
  <div style="text-align: center">
    ...
    <div style="margin: 0 20px" v-if="active === 0">
      <div style="margin-top: 80px">
        ...
        <div style="font-size: 15px; color: grey">请输入电子邮件地址</div>
      </div>
    ...
    <div style="margin: 0 20px" v-if="active === 1">
      <div style="margin-top: 80px">
        <div style="font-size: 25px; font-weight: bold">重置密码</div>
        <div style="font-size: 15px; color: grey">请输入新密码</div>
      </div>
      ...
      <div style="margin-top: 80px">
        <el-button @click="active++" style="width: 270px" type="danger" plain>重置密码</el-button>
      </div>
